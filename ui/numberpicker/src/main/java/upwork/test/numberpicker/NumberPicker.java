package upwork.test.numberpicker;
...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectionDivider = ContextCompat.getDrawable(context, upwork.test.numberpicker.R.drawable.np_numberpicker_selection_divider);

        mSelectionDividerColor = attributesArray.getColor(upwork.test.numberpicker.R.styleable.NumberPicker_np_dividerColor, mSelectionDividerColor);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
                upwork.test.numberpicker.R.styleable.NumberPicker_np_dividerDistance, defSelectionDividerDistance);
...
//                mSelectionDivider.draw(canvas);
                ...
                mSelectionDivider.setBounds((int) dpToPx(5), topOfBottomDivider, (int) dpToPx(45), bottomOfBottomDivider);
                mSelectionDivider.draw(canvas);
            }
        }
    }
    ...
    public void setTypeface(Typeface typeface) {
        mTypeface = typeface;
        if (mTypeface != null) {
            mSelectedText.setTypeface(Typeface.DEFAULT_BOLD);
            mSelectorWheelPaint.setTypeface(Typeface.DEFAULT);
        } else {
