...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectionDivider = ContextCompat.getDrawable(context, sad.ru.numberpicker.R.drawable.np_numberpicker_selection_divider);

        mSelectionDividerColor = attributesArray.getColor(sad.ru.numberpicker.R.styleable.NumberPicker_np_dividerColor, mSelectionDividerColor);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
                sad.ru.numberpicker.R.styleable.NumberPicker_np_dividerDistance, defSelectionDividerDistance);
